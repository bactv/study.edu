...
<footer class="w3-container w3-padding-32 w3-teal w3-center">
    ...
    <div class="w3-section">
        <div class="w3-col l6 m6 s12 w3-left" style="text-align: left;"><a href="<?php echo Url::toRoute(['/']) ?>">Trang chủ</a> | <a href="<?php echo Url::toRoute(['/gioi-thieu']) ?>">Giới thiệu</a> | <a href="<?php echo Url::toRoute(['/khoa-hoc-truc-tuyen']) ?>">Khóa học</a> | <a href="<?php echo Url::toRoute(['/lien-he']) ?>">Liên hệ</a></div>
        <div class="w3-col l6 m6 s12 w3-right" style="text-align: right;">Copyright &copy 2017 -  STUDY.EDU</div>
    </div>
</footer>
