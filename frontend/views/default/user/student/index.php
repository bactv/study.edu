        ...
        <fieldset style="margin-bottom: 30px">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo Url::toRoute(['/tai-khoan']) ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="school" name="school" placeholder="Trường ..." value="<?php echo $model['school'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" id="phone" name="phone" placeholder="Số ĐT ..." value="<?php echo $model['phone'] ?>">
                    </div>
                </div>
