    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'trac-nghiem-tong-hop/' => 'quiz/index',
                'trac-nghiem-tong-hop/<subject:[0-9a-zA-Z\-]+>' => 'quiz/index',
                ...
                'quan-ly-khoa-hoc/news' => 'course-manager/news',
                'quan-ly-khoa-hoc/create-news' => 'course-manager/create-news',
                'quan-ly-khoa-hoc/update-news' => 'course-manager/updated-news',
                'quan-ly-khoa-hoc/view-news' => 'course-manager/view-news',

                'lich-su-giao-dich' => 'user/history-transaction',
                'thong-bao' => 'user/list-notification',
                'thong-bao/<id:[0-9]+>' => 'user/notification-detail',
                'phan-hoi' => 'user/create-feedback',
